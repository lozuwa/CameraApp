...
public class ControllerAndCamera extends AppCompatActivity {
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
            mBackgroundHandler.post(new ControllerAndCamera.ImageSaver(reader.acquireNextImage(), mFile));
        }
    ...
    private void showToast(final String text) {
        Toast.makeText(ControllerAndCamera.this, text, Toast.LENGTH_SHORT).show();
    }
