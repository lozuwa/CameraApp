...
public class PrepareAndLoadSampleAutomatic extends Activity implements OnShowcaseEventListener {
    /** UI Elements */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /** Content */
        setContentView(R.layout.activity_prepare_and_load_sample_automatic);
        /** Orientation */
        ...
        ready.setOnClickListener( new View.OnClickListener(){
            public void onClick(View v) {
                ...
                Intent intent = new Intent(PrepareAndLoadSampleAutomatic.this, CameraActivity.class);
    ...
    public void publishMessage(String topic, String message) {
        ...
        try {
            ...
            MQTTServiceCommand.publish(PrepareAndLoadSampleAutomatic.this, topic, encodedPayload, 2);
