...
public class Camera2BasicFragment extends Fragment implements View.OnClickListener, FragmentCompat.OnRequestPermissionsResultCallback, MqttCallback{
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        R.array.parasite_array, android.R.layout.simple_spinner_item);
                ...
                public void onSuccess(IMqttToken asyncActionToken) {
                    ...
                    try {
                        ...
                        subToken.setActionCallback(new IMqttActionListener(){
                            @Override
                            public void onSuccess(IMqttToken asyncActionToken){
                                //showToast("Successfully subscribed to: " + topic.toString());
                            }
    ...
    public void messageArrived(String topic, MqttMessage message) throws Exception {
        ...
        if (c > 0) {
            if (params_payload[0].equals("pic")) {
                ...
                mFile = new File(getActivity().getExternalFilesDir(null), mFile_name + ".jpg");
                takePicture();
