...
public class JustCameraFragment extends Fragment implements View.OnClickListener,
     ...
     */
    private static final String TAG = "JustCameraFragment";
    ...
    private static Size chooseOptimalSize(Size[] choices, int textureViewWidth,
        ...
        if (bigEnough.size() > 0) {
            return Collections.min(bigEnough, new JustCameraFragment.CompareSizesByArea());
        } else if (notBigEnough.size() > 0) {
            return Collections.max(notBigEnough, new JustCameraFragment.CompareSizesByArea());
        } else {
    ...
    public static JustCameraFragment newInstance() {
        return new JustCameraFragment();
    }
    /**************************************************************************************************************************************/
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        /** Contents */
        return inflater.inflate(R.layout.fragment_just_camera, container, false);
    }
    ...
    private void requestCameraPermission() {
        if (FragmentCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.CAMERA)) {
            new JustCameraFragment.ConfirmationDialog().show(getChildFragmentManager(), FRAGMENT_DIALOG);
        } else {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == REQUEST_CAMERA_PERMISSION) {
            if (grantResults.length != 1 || grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                JustCameraFragment.ErrorDialog.newInstance(getString(R.string.request_permission))
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                Size largest = Collections.max(
                        ...
                        new JustCameraFragment.CompareSizesByArea());
            ...
            JustCameraFragment.ErrorDialog.newInstance(getString(R.string.camera_error))
                    .show(getChildFragmentManager(), FRAGMENT_DIALOG);
        }
    }

    /**
     * Opens the camera specified by {@link JustCameraFragment#mCameraId}.
     */
    ...
    public static class ErrorDialog extends DialogFragment {
        ...
        public static JustCameraFragment.ErrorDialog newInstance(String message) {
            JustCameraFragment.ErrorDialog dialog = new JustCameraFragment.ErrorDialog();
