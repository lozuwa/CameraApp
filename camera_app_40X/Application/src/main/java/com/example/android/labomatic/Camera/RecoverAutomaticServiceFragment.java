...
import com.example.android.labomatic.Firebase.UploadImages;
...
public class RecoverAutomaticServiceFragment extends Fragment implements View.OnClickListener,
    ...
    private static Size chooseOptimalSize(Size[] choices, int textureViewWidth,
        ...
        if (bigEnough.size() > 0) {
            return Collections.min(bigEnough, new RecoverAutomaticServiceFragment.CompareSizesByArea());
        } else if (notBigEnough.size() > 0) {
            return Collections.max(notBigEnough, new RecoverAutomaticServiceFragment.CompareSizesByArea());
        } else {
    ...
    public static RecoverAutomaticServiceFragment newInstance() {
        return new RecoverAutomaticServiceFragment();
    }
    /**************************************************************************************************************************************/
    ...
    /** Check if the external sd card is mounted
     * @return a boolean that defines if the
     * */
    ...
    private void requestCameraPermission() {
        if (FragmentCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.CAMERA)) {
            new RecoverAutomaticServiceFragment.ConfirmationDialog().show(getChildFragmentManager(), FRAGMENT_DIALOG);
        } else {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == REQUEST_CAMERA_PERMISSION) {
            if (grantResults.length != 1 || grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                RecoverAutomaticServiceFragment.ErrorDialog.newInstance(getString(R.string.request_permission))
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                Size largest = Collections.max(
                        ...
                        new RecoverAutomaticServiceFragment.CompareSizesByArea());
            ...
            RecoverAutomaticServiceFragment.ErrorDialog.newInstance(getString(R.string.camera_error))
                    .show(getChildFragmentManager(), FRAGMENT_DIALOG);
        }
    }

    /**
     * Opens the camera specified by {@link RecoverAutomaticServiceFragment#mCameraId}.
     */
    ...
    public static class ErrorDialog extends DialogFragment {
        ...
        public static RecoverAutomaticServiceFragment.ErrorDialog newInstance(String message) {
            RecoverAutomaticServiceFragment.ErrorDialog dialog = new RecoverAutomaticServiceFragment.ErrorDialog();
