...
import com.example.android.labomatic.Databases.Auxiliar.Auxiliar;
import com.example.android.labomatic.Databases.Users.User;
import com.example.android.labomatic.UI.CreatePatient;
...
public class ControllerAndCameraFragment extends Fragment implements View.OnClickListener,
     ...
     */
    private static final String TAG = "ControllerAndCameraFragment";
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
            mBackgroundHandler.post(new ControllerAndCameraFragment.ImageSaver(reader.acquireNextImage(), mFile));
        }
    ...
    private static Size chooseOptimalSize(Size[] choices, int textureViewWidth,
        ...
        if (bigEnough.size() > 0) {
            return Collections.min(bigEnough, new ControllerAndCameraFragment.CompareSizesByArea());
        } else if (notBigEnough.size() > 0) {
            return Collections.max(notBigEnough, new ControllerAndCameraFragment.CompareSizesByArea());
        } else {
    ...
    public static ControllerAndCameraFragment newInstance() {
        return new ControllerAndCameraFragment();
    }
    /**************************************************************************************************************************************/
    ...
    private MQTTServiceReceiver receiver = new MQTTServiceReceiver() {
        ...
        public void onMessageArrived(Context context, String topic, byte[] payload) {
            ...
            if (command.equals("takePictureRemoteController")) {
                ...
                /** Clean DB */
                mydatabase.execSQL("DROP TABLE IF EXISTS " + Auxiliar.TABLE_NAME);
                /** Go home */
    ...
    private void requestCameraPermission() {
        if (FragmentCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.CAMERA)) {
            new ControllerAndCameraFragment.ConfirmationDialog().show(getChildFragmentManager(), FRAGMENT_DIALOG);
        } else {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == REQUEST_CAMERA_PERMISSION) {
            if (grantResults.length != 1 || grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                ControllerAndCameraFragment.ErrorDialog.newInstance(getString(R.string.request_permission))
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                Size largest = Collections.max(
                        ...
                        new ControllerAndCameraFragment.CompareSizesByArea());
            ...
            ControllerAndCameraFragment.ErrorDialog.newInstance(getString(R.string.camera_error))
                    .show(getChildFragmentManager(), FRAGMENT_DIALOG);
        }
    }

    /**
     * Opens the camera specified by {@link ControllerAndCameraFragment#mCameraId}.
     */
    ...
    public static class ErrorDialog extends DialogFragment {
        ...
        public static ControllerAndCameraFragment.ErrorDialog newInstance(String message) {
            ControllerAndCameraFragment.ErrorDialog dialog = new ControllerAndCameraFragment.ErrorDialog();
