...
import com.example.android.labomatic.Camera.ControllerAndCamera;
...
public class CreatePatient extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        grantPermissions();
        // Open auxiliar db
        mydatabase = openOrCreateDatabase(Auxiliar.TABLE_NAME, MODE_PRIVATE, null);
        initializeDb();
    ...
    public void createFolder(String FOLDER_NAME) {
        ...
        mydatabase.execSQL("INSERT INTO " + Auxiliar.TABLE_NAME + " VALUES('" + FOLDER_NAME + "');");
        // Create folder
    ...
    public void initializeDb() {
        ...
        // Create table again
        mydatabase.execSQL("CREATE TABLE IF NOT EXISTS " + Auxiliar.TABLE_NAME + "(" + Auxiliar.COLUMN_NAME_TITLE + " VARCHAR);");
    }
