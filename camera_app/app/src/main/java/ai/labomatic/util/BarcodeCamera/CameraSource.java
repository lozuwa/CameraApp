...
public class CameraSource {
    ...
    public interface ShutterCallback {
         ...
         * This may be some time after the photo was triggered, but some time before the actual ai.labomatic.data
         * is available.
         */
        void onShutter();
    }
    ...
    /**
     * Callback interface used to supply image ai.labomatic.data from a photo capture.
     */
    public interface PictureCallback {
        /**
         * Called when image ai.labomatic.data is available after a picture is taken.  The format of the ai.labomatic.data
         * is a jpeg binary.
         */
     ...
     * @param jpeg    the callback for JPEG image ai.labomatic.data, or null
     */
    ...
    private class FrameProcessingRunnable implements Runnable {
        ...
        /**
         * Sets the frame ai.labomatic.data received from the camera.  This adds the previous unused frame buffer
         * (if present) back to the camera, and keeps a pending reference to the frame ai.labomatic.data for
         * future use.
         */
            ...
            synchronized (mLock) {
                ...
                if (!mBytesToByteBuffer.containsKey(data)) {
                    Log.d(TAG,
                        ...
                        "ai.labomatic.data from the camera.");
                    return;
                }
        ...
        public void run() {
            ...
            while (true) {
                synchronized (mLock) {
                    ...
                    // Hold onto the frame ai.labomatic.data locally, so that we can use this for detection
                    // below.  We need to clear mPendingFrameData to ensure that this buffer isn't
                    // recycled back to the camera before we are done using that ai.labomatic.data.
